...
Search_result *search_with_rrn(FILE *data_file, FILE *index_file, long data_offset, Search_criteria *criteria, int num_fields, int *count)
{
    *count = 0;
    ...
    Search_result *results = (Search_result*)malloc(capacity * sizeof(Search_result));
    ...
    if (has_station_code != NO_DATA_ERROR && index_file != NULL)
    {
            ...
            matches_record_criteria(rec, criteria, num_fields) == 0)
        {
            ...
            results = (Search_result*)realloc(results, sizeof(Search_result));
    ...
    while (1)
    {
            ...
            matches_record_criteria(rec, criteria, num_fields) == 0)
        {
            ...
            if (*count == capacity)
            {
                ...
                Search_result *temp = (Search_result*)realloc(results, capacity * sizeof(Search_result));
